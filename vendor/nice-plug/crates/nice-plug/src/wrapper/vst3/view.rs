    ...
    pub unsafe fn request_resize(this: &ComWrapper<Self>) -> bool {
        ...
        match &*this.plug_frame.read() {
            Some(plug_frame) => {
                ...
                crate::nice_log!(
                    "WrapperView::request_resize calling host resizeView({}x{})",
                    physical_size.width,
                    physical_size.height
                );
                let result = unsafe { plug_frame.resizeView(plug_view.as_ptr(), &mut size) };
                crate::nice_log!("WrapperView::request_resize host resizeView returned (result = {result})");
...
impl<P: Vst3Plugin> IPlugViewTrait for WrapperView<P> {
    ...
    unsafe fn attached(&self, parent: *mut c_void, type_: FIDString) -> tresult {
        crate::nice_log!("WrapperView::attached called");
    ...
    unsafe fn removed(&self) -> tresult {
        crate::nice_log!("WrapperView::removed called");
        let mut editor_handle = self.editor_handle.lock();
    ...
    unsafe fn getSize(&self, size: *mut ViewRect) -> tresult {
        crate::nice_log!("WrapperView::getSize called");
        check_null_ptr!(size);
    ...
    unsafe fn onSize(&self, new_size: *mut ViewRect) -> tresult {
        crate::nice_log!("WrapperView::onSize called");
    ...
    unsafe fn setFrame(&self, frame: *mut IPlugFrame) -> tresult {
        crate::nice_log!("WrapperView::setFrame called");
    ...
    unsafe fn canResize(&self) -> tresult {
        crate::nice_log!("WrapperView::canResize called");
    ...
    unsafe fn checkSizeConstraint(&self, rect: *mut ViewRect) -> tresult {
        crate::nice_log!("WrapperView::checkSizeConstraint called");
        check_null_ptr!(rect);
...
impl<P: Vst3Plugin> IPlugViewContentScaleSupportTrait for WrapperView<P> {
    unsafe fn setContentScaleFactor(&self, factor: ScaleFactor) -> tresult {
        crate::nice_log!("WrapperView::setContentScaleFactor called (factor = {factor})");
